   ...
   <!-- Page Preloder -->
	...
	<!-- Hero section end -->
        <div  class="section-title">
                            &nbsp;&nbsp;&nbsp;
                            <h2 class="fw-title">WOMEN'S WEAR</h2>
			</div>
	<!-- Category section -->
							...
							<div class="product-item">
								<div class="pi-pic">	                                                                   
									...
									<div class="pi-links">
										...
										<a href="WomensWearJeans.jsp" class="add-card"><img src='img/logo.png'><span></span></a>						
									</div>
								</div>
								<div class="pi-text">									
                                                                    <p style="text-align: center">Women's Wear Jeans</p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
                                                                            <a href="" class="add-card"><i class="flaticon-bag"></i><span>Shop Now!</span></a>
                                                                            <a href="WomenWearJacket.jsp" class="add-card"><img src='img/logo.png'><span></span></a>
										
									</div>
								</div>
								<div class="pi-text">
									
                                                                    <p style="text-align: center">Women's Wear Jacket</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
                                                                            <a href="" class="add-card"><i class="flaticon-bag"></i><span>Shop Now!</span></a>
										<a href="WomenWearJumpsuit.jsp" class="add-card"><img src='img/logo.png'><span></span></a>
										
									</div>
								</div>                                                            
								<div class="pi-text">
									
                                                                    <p style="text-align: center">Trendy JumpSuits</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
                                                                            <a href="" class="add-card"><i class="flaticon-bag"></i><span>Shop Now!</span></a>
                                                                            <a href="WomensWearKurti.jsp" class="add-card"><img src='img/logo.png'><span></span></a>
									</div>
								</div>
								<div class="pi-text">
									
                                                                    <p style="text-align: center">Stylist Kurti Collections</p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
                                                                            <a href="" class="add-card"><i class="flaticon-bag"></i><span>Shop Now!</span></a>
										<a href="WomenWearEthnic.jsp" class="add-card"><img src='img/logo.png'><span></span></a>
										
									</div>
								</div>
								<div class="pi-text">
									
                                                                    <p style="text-align: center">Trendy Ethnic Wear</p>
								</div>
							</div>
