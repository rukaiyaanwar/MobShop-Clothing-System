...
<%     
    String password = request.getParameter("curr_pwd");   //to retrieve the input values from Form.
    String newPassword = request.getParameter("new_pwd"); //to retrieve the input values from Form.
    ...
    try{
        ...
        String qry1 = "UPDATE CUSTOMER SET PASSWORD=? WHERE PASSWORD='"+password+"'";     //Sending the query
