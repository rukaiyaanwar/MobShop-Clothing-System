<%-- 
    Document   : FeedbackProductText
    Created on : Sep 26, 2019, 3:29:33 PM
    Author     : Virus
--%>
            ...
            <div id="profile-right" class="container">
                <div class="login_form_inner reg_form ">
                    ...
                    <div class="container" style="width: 500px;" id="feedback" >
                        <form action="FeedbackProductDB.jsp" method="get">                                
                            <table class="table " style="margin: 20px;">
                                <tr>
                                    <td >
                                        <textarea type="text" style="  height: 150px;" class="form-control" placeholder="Please enter your feedback here" autofocus name="feedbackText" maxlength="80" required="" ></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td >
                                        <input type="text" class="form-control" readonly="" value="<%= session.getAttribute("customer_name")  %>" name="feedbackText" maxlength="80" />                                    
                                    </td>
                                </tr>
                                <tr>
                                    <td >
                                        <input type="hidden" name="order_id"  class="form-control" readonly="" value="<%= order %>" name="order_id" maxlength="80" />                                    
                                    </td>
                                </tr>
                                <tr>
                                    <td >
                                        <input type="submit"  value="Submit"  class="form-control " style="background-color: #F51167; color:white; "  />                                    
                                    </td>
                                </tr>
