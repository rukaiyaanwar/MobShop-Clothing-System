				...
				<div class="col-lg-3 order-2 order-lg-1">
					<div class="filter-widget">
						...
						<ul class="category-menu">
							<li><a href="WomenWear.jsp">Woman wear</a>
								<ul class="sub-menu">
									<li><a href="WomensWearJeans.jsp">Women's Wear Jeans <span>(2)</span></a></li>
									<li><a href="WomensWearKurti.jsp">Stylish Kurti<span>(56)</span></a></li>
									<li><a href="WomenWearEthnic.jsp">Ethnic Dress <span>(36)</span></a></li>
									<li><a href="WomenWearJacket.jsp">Women's Wear Jacket<span>(27)</span></a></li>
									<li><a href="WomenWearJumpsuit.jsp">Jumpsuits<span>(19)</span></a></li>
								</ul>
							</li>
							<li><a href="MenWear.jsp">Man Wear</a>
								<ul class="sub-menu">
									<li><a href="MensWearJeans.jsp">Men's Wear Jeans<span>(2)</span></a></li>
									<li><a href="MenWearSuit.jsp">Men's Wear Suits<span>(56)</span></a></li>
									<li><a href="MensWearTshirt.jsp">T-Shirts<span>(36)</span></a></li>
                                                                        <li><a href="MensWearshirts.jsp">Men's Wear Shirts<span>(36)</span></a></li>
                                                                        <li><a href="MensWearJackets.jsp">Men's Wear Jacket<span>(36)</span></a></li>
								</ul></li>
							<li><a href="KidsWearJeans.jsp">Children</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
					<div class="row">
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<img src="./img/product/jeans001.jpg" alt="">
									<div class="pi-links">
										<a href="AddtoCart.jsp?prod=1041" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans002.jpg" alt="">
									<div class="pi-links">
										<a href="AddtoCart.jsp?prod=1042" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								</div>
								<div class="pi-text">
									<h6>Rs.1,499/-</h6>
									<p>Black Skinny Tight Jeans</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans003.jpg" alt="">
									<div class="pi-links">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans004.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans005.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>Rs.3,999/-</h6>
									<p>Shirt & Jeans Stylish Dressing</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans006.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>Rs.2,499/-</h6>
									<p>Stylish Kids Wear Combo Dress</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans007.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>Rs.3,999/-</h6>
									<p>Combo Dress with Printed Inner</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans008.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans009.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<img src="./img/product/jeans0010.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans0011.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>Rs.1,899/-</h6>
									<p>Cool Denim Kids Wear Jeans</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/jeans0012.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
...
<p class="text-white text-center mt-5">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <img src="img/Heart.png" width="25" height="25">  by <a href="homepage.jsp" target="_blank">Mobshop Clothing</a></p>
			</div>
		</div>
	</section>
	<!-- Footer section end -->
