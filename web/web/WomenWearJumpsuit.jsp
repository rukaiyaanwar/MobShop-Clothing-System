...
<html>
<head>
	<title>Women's Wear : Jacket</title>
	<meta charset="UTF-8">	
		...
		<nav class="main-navbar">
         ...
         &nbsp;&nbsp;&nbsp;
             <div  class="section-title">
                            &nbsp;&nbsp;&nbsp;
                            <h2 style="font-size: 20px" class="fw-title">JUMPSUIT COLLECTIONS</h2>
			</div>
	<!-- Category section -->
					...
					<div class="row">
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
										<a href="AddtoCart.jsp?prod=1028" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								</div>
								<div class="pi-text">
									<h6>Rs.1,999/-</h6>
									<p>Orange Floral Printed Jumpsuit</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
										<a href="AddtoCart.jsp?prod=1029" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								</div>
								<div class="pi-text">
									<h6>Rs.2,999/-</h6>
									<p>Black Elegant Jumpsuit</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.3,699/-</h6>
									<p>Black and White Stripes Jumpsuit</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.4,999/-</h6>
									<p>Yellow Floral Printed Jumpsuit</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.1,599</h6>
									<p>Black & Red Checked Jumpsuit</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
