...
<!--        <%@page import="java.io.*" %>  //this statement means all the classes of io package will be imported. used when we are using input/output stream.-->
        ...
        <%
            try
            {
                ...
                String qry = "SELECT ORDERS.ORDER_ID,PRODUCT.PROD_ID,PRODUCT.PROD_NAME,PRODUCT.PROD_IMG,ORDERS.PROD_PRICE,ORDERS.TOTAL_QTY,ORDERS.TOTAL_PRICE,ORDERS.ORDER_DATE,ORDERS.ORDER_ADDR,ORDERS.ORDER_STATUS FROM ORDERS INNER JOIN PRODUCT ON ORDERS.PROD_ID = PRODUCT.PROD_ID AND ORDER_STATUS='CANCEL ORDER'";   // //Sending the query         
