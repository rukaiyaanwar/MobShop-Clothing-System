			...
			<div class="row">
				<div class="col-lg-6">
					<div class="product-pic-zoom">
						<img class="product-big-img" src="img/product/jeans1.jpg" alt="">
					</div>
					<div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
						<div class="product-thumbs-track">
							<div class="pt active" data-imgbigurl="img/product/jeans1.jpg"><img src="img/product/jeans1.jpg" alt=""></div>
							<div class="pt" data-imgbigurl="img/product/jeans110.jpg"><img src="img/product/jeans110.jpg" alt=""></div>
							<div class="pt" data-imgbigurl="img/product/j10.jpg"><img src="img/product/j10.jpg" alt=""></div>
							<div class="pt" data-imgbigurl="img/product/j11.jpg"><img src="img/product/j11.jpg" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 product-details">
					<h2 class="p-title">Mid Wash Jeans</h2>
					<h3 class="p-price">Rs.1599/-</h3>
