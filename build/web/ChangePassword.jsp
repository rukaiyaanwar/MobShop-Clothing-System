...
<!--         //this statement means all the classes of io package will be imported. used when we are using input/output stream. :java.sql.*;-->
    <%
        if((session.getAttribute("customer_id")==null)||(session.getAttribute("customer_id")=="")) // This method is used to save an object in session by assigning a unique string to the object.
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
                                            <img class="img-fluid" src="img/product/jumpsuit8.jpg" width="600" height="300"alt="">
						<div class="hover">
				...
				<div class="col-lg-6">
					<div class="login_form_inner reg_form">
						...
						<form class="row login_form" action="ChangePasswordDB.jsp" method="get" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="current" name="curr_pwd" placeholder="Current Password">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="password" name="new_pwd" placeholder="Enter New Password">
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
                                                            <button type="submit" value="submit" class="btn submit_btn" onclick="return validate()">Change Password</button>                                            
							</div>
						</form>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="footer-widget about-widget">
						...
						<ul>
							<li><a href="WomensWearJeans.html">Women's Wear Jeans</a></li>
							<li><a href="WomenWearJumpsuit.html">Trendy Jumpsuits</a></li>
							<li><a href="MensWearJackets.html">Men's Wear Jacket</a></li>
							<li><a href="MenWearSuit.html">Men's Wear Trendy Suits</a></li>
							<li><a href="WomenWearJacket.html">Women's Wear Jacket</a></li>
							<li><a href="WomensWearKurti.html">Stylish Kurti</a></li>
						</ul>						
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
