				...
				<form  action="AccountUpdate.jsp" method="get" >
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td> <input type="text" class="form-control"  name="ACname"  value="<%= rs.getString("C_NAME") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Email </td>
                                            <td> <input type="text" class="form-control"  name="ACemail"  value="<%= rs.getString("C_EMAIL") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Address </td>
                                            <td> <input type="text" class="form-control"  name="ACaddr"  value="<%= rs.getString("C_ADDR") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Contact No </td>
                                            <td> <input type="text" class="form-control"  name="ACmob"  value="<%= rs.getString("C_PHONE") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
