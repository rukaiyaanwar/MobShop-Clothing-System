				...
				<form  action="AccountUpdateDB.jsp" method="get" >
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td> <input type="text" class="form-control"  name="ACname"  value="<%= rs.getString("customer_name") %>" > </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Email </td>
                                            <td> <input type="text" class="form-control"  name="ACemail"  value="<%= rs.getString("customer_email") %>" > </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Address </td>
                                            <td> <input type="text" class="form-control"  name="ACaddr"  value="<%= rs.getString("customer_addr") %>" > </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Contact No </td>
                                            <td> <input type="text" class="form-control"  name="ACmob"  value="<%= rs.getString("customer_mob") %>" > </td>
                                        </tr>
                                        <tr>
