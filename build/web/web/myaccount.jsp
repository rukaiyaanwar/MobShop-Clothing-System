			...
			<div class="login_form_inner reg_form ">
				<h3>Personal Information</h3>
                                <%
                                    if(rs.next()){                                   
                                %>
				<form  action="AccountUpdate.jsp" method="get" >
                                    <table class="table">
                                        <tr>
                                            <td id="myAccountName"> Name </td>
                                            <td> <input type="text" class="form-control"  name="ACname"  value="<%= rs.getString("customer_name") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Email </td>
                                            <td> <input type="text" class="form-control"  name="ACemail"  value="<%= rs.getString("customer_email") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Address </td>
                                            <td> <input type="text" class="form-control"  name="ACaddr"  value="<%= rs.getString("customer_addr") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
                                            <td  id="myAccountName">Contact No </td>
                                            <td> <input type="text" class="form-control"  name="ACmob"  value="<%= rs.getString("customer_mob") %>" disabled=""> </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"> <button type="submit" value="submit" class="btn submit_btn" style="width: 200px; border-radius: 5px; margin-top: 10px;">Update</button>  </td>                                            
                                        </tr>                                        
                                    </table>						                                                            				
				</form>
                                <%
