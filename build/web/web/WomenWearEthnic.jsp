...
<html>
<head>
	<title>Women's Wear : Ethnics</title>
	<meta charset="UTF-8">	
		...
		<nav class="main-navbar">
         ...
         &nbsp;&nbsp;&nbsp;
             <div  class="section-title">
                            &nbsp;&nbsp;&nbsp;
                            <h2 style="font-size: 20px" class="fw-title">ETHNIC WEAR</h2>
			</div>
					...
					<div class="row">
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
										<a href="AddtoCart.jsp?prod=1024" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								</div>
								<div class="pi-text">
									<h6>Rs.1,599</h6>
									<p>Cute Floral Printed Dress</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
										<a href="AddtoCart.jsp?prod=1025" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								</div>
								<div class="pi-text">
									<h6>Rs.4,999/-</h6>
									<p>Embroidered Black Long Dress</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.5999/-</h6>
									<p>Multicolor Color Stylish Dress</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.4,999/-</h6>
									<p>Colored Checked Branded Ethnic Wear</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.2,999/-</h6>
									<p>Peach Dress in Long Pattern</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.2,599/-</h6>
									<p>Black & Yellowish Ethnic Wear</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-text">
									<h6>Rs.5,999</h6>
									<p>Designer MutilColor Ethnic Wear</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./img/product/ethnic12.jpg" alt="">
									<div class="pi-links">
										<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>Rs.7,999/-</h6>
									<p>Yellowish Black Ethnic Wear </p>
								</div>
							</div>
						</div>
					</div>
