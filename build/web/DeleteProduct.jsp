			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
                                            <img class="img-fluid" src="img/product/jacket07.jpg" width="600" height="300"alt="">
						<div class="hover">
				...
				<div class="col-lg-6">
					<div class="login_form_inner reg_form">
						...
						<form class="row login_form" action="DeleteProductDB.jsp" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="btn submit_btn"type="submit">DELETE PRODUCT</button>
