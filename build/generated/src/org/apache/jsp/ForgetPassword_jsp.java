...
public final class ForgetPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                            <img class=\"img-fluid\" src=\"img/product/jacket01.jpg\" width=\"600\" height=\"300\"alt=\"\">\n");
      ...
      out.write("\t\t\t\t\t\t<h3>Do You Forget Your Password ?</h3>\n");
      out.write("\t\t\t\t\t\t<form class=\"row login_form\" action=\"AccountValidate.jsp\" method=\"get\" id=\"contactForm\" novalidate=\"novalidate\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"email\" name=\"customer_email\" placeholder=\"Enter Your Email Address\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"submit\" value=\"submit\" class=\"btn submit_btn\">Send Message</button>\n");
      out.write("                                                               \n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</div>\n");
