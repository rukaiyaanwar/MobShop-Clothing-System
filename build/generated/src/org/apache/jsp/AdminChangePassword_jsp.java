...
public final class AdminChangePassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                            <img class=\"img-fluid\" src=\"img/product/jumpsuit6.jpg\" width=\"600\" height=\"300\"alt=\"\">\n");
      ...
      out.write("\t\t\t\t\t\t<form class=\"row login_form\" action=\"AdminChangePasswordDB.jsp\" method=\"post\" id=\"contactForm\" novalidate=\"novalidate\">\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"email\" name=\"email\" placeholder=\"Enter New Password\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"password\" name=\"password\" placeholder=\" Confirm Password\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 form-group\">\n");
      out.write("                                                            <button type=\"submit\" value=\"submit\" class=\"btn submit_btn\">Change Password</button>                                            \n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\n");
